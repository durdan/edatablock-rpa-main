          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('clientAddress')}>
                  Client Address <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {clientList.map((client, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <TextFormat type="date" value={client.createDate} format={APP_DATE_FORMAT} />
                  </td>
