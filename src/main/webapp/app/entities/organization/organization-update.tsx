    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="edatablockrpamainApp.organization.home.createOrEditLabel">Create or edit a Organization</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : organizationEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="organization-isActive" type="string" className="form-control" name="isActive" />
                </AvGroup>
                <AvGroup>
