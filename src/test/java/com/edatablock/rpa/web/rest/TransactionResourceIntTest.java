...
public class TransactionResourceIntTest {
    ...
    public void createTransaction() throws Exception {
        ...
        assertThat(testTransaction.getCreatedDateTime()).isEqualTo(DEFAULT_CREATED_DATE_TIME);
        assertThat(testTransaction.getStatus()).isEqualTo(DEFAULT_STATUS);
        assertThat(testTransaction.getClientEmailAddress()).isEqualTo(DEFAULT_CLIENT_EMAIL_ADDRESS);
        assertThat(testTransaction.getMessageId()).isEqualTo(DEFAULT_MESSAGE_ID);
    ...
    public void checkClientEmailAddressIsRequired() throws Exception {
        ...
        // set the field null
        transaction.setClientEmailAddress(null);
    ...
    public void updateTransaction() throws Exception {
        ...
        Transaction testTransaction = transactionList.get(transactionList.size() - 1);
        assertThat(testTransaction.getCreatedDateTime()).isEqualTo(UPDATED_CREATED_DATE_TIME);
        assertThat(testTransaction.getStatus()).isEqualTo(UPDATED_STATUS);
        assertThat(testTransaction.getClientEmailAddress()).isEqualTo(UPDATED_CLIENT_EMAIL_ADDRESS);
        assertThat(testTransaction.getMessageId()).isEqualTo(UPDATED_MESSAGE_ID);
